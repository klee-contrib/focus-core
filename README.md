...
Then you have to launch the following command: `gulp build` which generates two outputs: one for the browser, one for node js (expecially for unit tests purpose).
