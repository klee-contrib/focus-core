...
/**
 * Configuration object. Except for xhrErrors and rateLimiter, see https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch
 * @type {{xhrErrors: Object}}
 */
let configuration = {
    xhrErrors: {},
