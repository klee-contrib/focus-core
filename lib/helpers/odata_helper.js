...
(function(NS) {
    ...
    function criteriaToOdata(criteria) {
        ...
        return result.length > 0 ? result.slice(0, -5) : ""; //Todo: corriger la création de critère. //result.substring(0, result.length - 1);
    }
    ...
    function orderToOdata(sortFields) {
        ...
        sortFields.forEach(function(sortField) {
            //TODO : cette condition n'est pas satisfaisante. Si ces champs ne sont pas définis ils ne devraient pas être dans la liste.
