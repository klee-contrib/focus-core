...
(function (NS) {
    ...
    var templatePagination = Fmk.templates.pagination;
    ...
    var ListView = CoreView.extend({
        ...
        events: {
            ...
            'click .pagination [data-page]': 'goToPage',
        ...
        render: function renderSearchResults(options) {
            ...
            if (this.model.length === 0) {
                ...
                var showFirst = !(infos.firstPage === infos.currentPage) && !(infos.firstPage === infos.previous);
                var showLast = !(infos.lastPage === infos.currentPage) && !(infos.lastPage === infos.next);

                //render pagination
                $(this.resultsPagination, this.$el).html(this.templatePagination(_.extend(infos, {showFirst: showFirst, showLast: showLast}))); //TODO : this.model.pageInfo() {currentPage: 0, firstPage: 0, totalPages: 10}
